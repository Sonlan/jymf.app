...
public class Common {
	...
	public static String fromDateStr(String dateStr) {
		DateFormat oriDf = new SimpleDateFormat("yyyyMMddHHmmss");
		DateFormat tarDf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		String tarStr = null;
		
		try {
			Date oriDate = oriDf.parse(dateStr);
			tarStr = tarDf.format(oriDate);
	...
	/**
	 * 每隔4位空一格 2014-5-22下午1:53:57
	 * 
	 * @param label
	 * @return
	 */
	public static String getPer4Space(String label) {
		return label.replaceAll("\\d{4}(?!$)", "$0  ");
	}
