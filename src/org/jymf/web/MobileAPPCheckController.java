...
public class MobileAPPCheckController {
	...
	private Logger logger = LoggerFactory.getLogger(MobileAPPCheckController.class);
	/**
	 * 验证中烟产品是否有微信红包活动URL
	 */
	 ...
	 * @return
	 */
	@RequestMapping(value = "/lchk", method = RequestMethod.POST)
	public String labelCheck( Model model, HttpSession session,HttpServletRequest request) {
		//删除session中的用户信息
